// beam_jni.c — JNI entry points for Scrawly.
// Generated by mix mob.new. Edit the two defines below; do not touch the rest.

#include <jni.h>
#include "mob_beam.h"

#define BRIDGE_CLASS  "com/example/scrawly/MobBridge"
#define APP_MODULE    "scrawly"
...
Java_com_example_scrawly_MainActivity_nativeSetActivity(JNIEnv* env, jobject thiz, jobject activity) {
    mob_init_bridge(env, activity);
}

JNIEXPORT void JNICALL
Java_com_example_scrawly_MainActivity_nativeStartBeam(JNIEnv* env, jobject thiz) {
    mob_start_beam(APP_MODULE);
}

// Called from MobBridge.nativeSendTap(handle) in Kotlin when a button is tapped.
JNIEXPORT void JNICALL
Java_com_example_scrawly_MobBridge_nativeSendTap(JNIEnv* env, jclass cls, jint handle) {
    mob_send_tap((int)handle);
}

// Called from MobBridge.nativeSendChangeStr/Bool/Float when an input widget changes.
JNIEXPORT void JNICALL
Java_com_example_scrawly_MobBridge_nativeSendChangeStr(JNIEnv* env, jclass cls, jint handle, jstring value) {
...
JNIEXPORT void JNICALL
Java_com_example_scrawly_MobBridge_nativeSendChangeBool(JNIEnv* env, jclass cls, jint handle, jboolean value) {
    mob_send_change_bool((int)handle, (int)value);
}

JNIEXPORT void JNICALL
Java_com_example_scrawly_MobBridge_nativeSendChangeFloat(JNIEnv* env, jclass cls, jint handle, jfloat value) {
    mob_send_change_float((int)handle, (double)value);
}

JNIEXPORT void JNICALL
Java_com_example_scrawly_MobBridge_nativeSendFocus(JNIEnv* env, jclass cls, jint handle) {
    mob_send_focus((int)handle);
}

JNIEXPORT void JNICALL
Java_com_example_scrawly_MobBridge_nativeSendBlur(JNIEnv* env, jclass cls, jint handle) {
    mob_send_blur((int)handle);
}

JNIEXPORT void JNICALL
Java_com_example_scrawly_MobBridge_nativeSendSubmit(JNIEnv* env, jclass cls, jint handle) {
    mob_send_submit((int)handle);
}

// Called from MobBridge.nativeHandleBack() when the Android back gesture fires.
JNIEXPORT void JNICALL
Java_com_example_scrawly_MobBridge_nativeHandleBack(JNIEnv* env, jclass cls) {
    mob_handle_back();
}
...
JNIEXPORT void JNICALL
Java_com_example_scrawly_MobBridge_nativeNotifyColorScheme(JNIEnv* env, jclass cls,
    jstring scheme) {
    if (!scheme) return;
...
JNIEXPORT void JNICALL
Java_com_example_scrawly_MobBridge_nativeDeliverAtom2(JNIEnv* env, jclass cls,
...
JNIEXPORT void JNICALL
Java_com_example_scrawly_MobBridge_nativeDeliverAtom3(JNIEnv* env, jclass cls,
...
JNIEXPORT void JNICALL
Java_com_example_scrawly_MobBridge_nativeDeliverLocation(JNIEnv* env, jclass cls,
    jlong pid, jdouble lat, jdouble lon, jdouble acc, jdouble alt) {
    mob_deliver_location(pid, lat, lon, acc, alt);
}

JNIEXPORT void JNICALL
Java_com_example_scrawly_MobBridge_nativeDeliverMotion(JNIEnv* env, jclass cls,
...
JNIEXPORT void JNICALL
Java_com_example_scrawly_MobBridge_nativeDeliverFileResult(JNIEnv* env, jclass cls,
...
JNIEXPORT void JNICALL
Java_com_example_scrawly_MobBridge_nativeDeliverCameraFrame(JNIEnv* env, jclass cls,
...
JNIEXPORT void JNICALL
Java_com_example_scrawly_MobBridge_nativeDeliverPushToken(JNIEnv* env, jclass cls,
...
JNIEXPORT void JNICALL
Java_com_example_scrawly_MobBridge_nativeDeliverNotification(JNIEnv* env, jclass cls,
...
JNIEXPORT void JNICALL
Java_com_example_scrawly_MobBridge_nativeSetLaunchNotification(JNIEnv* env, jclass cls,
    jstring json) {
...
JNIEXPORT void JNICALL
Java_com_example_scrawly_MobBridge_nativeDeliverWebViewMessage(JNIEnv* env, jclass cls,
    jlong pid, jstring json) {
    const char* cj = (*env)->GetStringUTFChars(env, json, NULL);
...
JNIEXPORT void JNICALL
Java_com_example_scrawly_MobBridge_nativeDeliverWebViewBlocked(JNIEnv* env, jclass cls,
...
JNIEXPORT void JNICALL
Java_com_example_scrawly_MobBridge_nativeDeliverAlertAction(JNIEnv* env, jclass cls,
    jstring action) {
...
JNIEXPORT void JNICALL
Java_com_example_scrawly_MobBridge_nativeDeliverComponentEvent(JNIEnv* env, jclass cls,
...
JNIEXPORT void JNICALL
Java_com_example_scrawly_MobBridge_nativeDeliverVendorUsbDevices(JNIEnv* env, jclass cls,
    jlong pid, jstring json) {
    const char* cj = (*env)->GetStringUTFChars(env, json, NULL);
...
JNIEXPORT void JNICALL
Java_com_example_scrawly_MobBridge_nativeDeliverVendorUsbPermission(JNIEnv* env, jclass cls,
...
JNIEXPORT void JNICALL
Java_com_example_scrawly_MobBridge_nativeDeliverVendorUsbOpened(JNIEnv* env, jclass cls,
...
JNIEXPORT void JNICALL
Java_com_example_scrawly_MobBridge_nativeDeliverVendorUsbData(JNIEnv* env, jclass cls,
...
JNIEXPORT void JNICALL
Java_com_example_scrawly_MobBridge_nativeDeliverVendorUsbWriteComplete(JNIEnv* env, jclass cls,
    jlong pid, jint session_id, jint bytes_written) {
    mob_deliver_vendor_usb_write_complete(pid, (int)session_id, (int)bytes_written);
}

JNIEXPORT void JNICALL
Java_com_example_scrawly_MobBridge_nativeDeliverVendorUsbEvent(JNIEnv* env, jclass cls,
...
JNIEXPORT void JNICALL
Java_com_example_scrawly_MobBridge_nativeDeliverBtDiscoveryStarted(JNIEnv* env, jclass cls,
    jlong pid) {
    mob_deliver_bt_discovery_started(pid);
}

JNIEXPORT void JNICALL
Java_com_example_scrawly_MobBridge_nativeDeliverBtDiscoveryFinished(JNIEnv* env, jclass cls,
    jlong pid) {
    mob_deliver_bt_discovery_finished(pid);
}

JNIEXPORT void JNICALL
Java_com_example_scrawly_MobBridge_nativeDeliverBtDiscoveryCancelled(JNIEnv* env, jclass cls,
    jlong pid) {
    mob_deliver_bt_discovery_cancelled(pid);
}

JNIEXPORT void JNICALL
Java_com_example_scrawly_MobBridge_nativeDeliverBtDiscovered(JNIEnv* env, jclass cls,
...
JNIEXPORT void JNICALL
Java_com_example_scrawly_MobBridge_nativeDeliverBtPaired(JNIEnv* env, jclass cls,
    jlong pid, jstring address, jstring name, jboolean bonded) {
    const char* c_address = (*env)->GetStringUTFChars(env, address, NULL);
    const char* c_name    = (*env)->GetStringUTFChars(env, name,    NULL);
...
JNIEXPORT void JNICALL
Java_com_example_scrawly_MobBridge_nativeDeliverBtPairFailed(JNIEnv* env, jclass cls,
...
JNIEXPORT void JNICALL
Java_com_example_scrawly_MobBridge_nativeDeliverBtUnpaired(JNIEnv* env, jclass cls,
...
JNIEXPORT void JNICALL
Java_com_example_scrawly_MobBridge_nativeDeliverBtError(JNIEnv* env, jclass cls,
...
JNIEXPORT void JNICALL
Java_com_example_scrawly_MobBridge_nativeDeliverBtPairedListBegin(JNIEnv* env, jclass cls,
    jlong pid) {
    mob_deliver_bt_paired_list_begin(pid);
}

JNIEXPORT void JNICALL
Java_com_example_scrawly_MobBridge_nativeDeliverBtPairedListEntry(JNIEnv* env, jclass cls,
    jlong pid, jstring address, jstring name, jboolean bonded) {
    const char* c_address = (*env)->GetStringUTFChars(env, address, NULL);
    const char* c_name    = (*env)->GetStringUTFChars(env, name,    NULL);
...
JNIEXPORT void JNICALL
Java_com_example_scrawly_MobBridge_nativeDeliverBtPairedListFinish(JNIEnv* env, jclass cls,
    jlong pid) {
...
JNIEXPORT void JNICALL
Java_com_example_scrawly_MobBridge_nativeDeliverBtHfpConnecting(JNIEnv* env, jclass cls,
...
JNIEXPORT void JNICALL
Java_com_example_scrawly_MobBridge_nativeDeliverBtHfpConnected(JNIEnv* env, jclass cls,
...
JNIEXPORT void JNICALL
Java_com_example_scrawly_MobBridge_nativeDeliverBtHfpConnectFailed(JNIEnv* env, jclass cls,
    jlong pid, jstring address, jstring reason) {
    const char* c_address = (*env)->GetStringUTFChars(env, address, NULL);
    const char* c_reason  = (*env)->GetStringUTFChars(env, reason,  NULL);
...
JNIEXPORT void JNICALL
Java_com_example_scrawly_MobBridge_nativeDeliverBtHfpDisconnected(JNIEnv* env, jclass cls,
...
JNIEXPORT void JNICALL
Java_com_example_scrawly_MobBridge_nativeDeliverBtHfpVendorSubscribed(JNIEnv* env, jclass cls,
    jlong pid, jint session) {
    mob_deliver_bt_hfp_vendor_subscribed(pid, (int)session);
}

JNIEXPORT void JNICALL
Java_com_example_scrawly_MobBridge_nativeDeliverBtHfpVendorAt(JNIEnv* env, jclass cls,
...
JNIEXPORT void JNICALL
Java_com_example_scrawly_MobBridge_nativeDeliverBtHfpScoStarted(JNIEnv* env, jclass cls,
    jlong pid, jint session, jstring address) {
    const char* c_address = (*env)->GetStringUTFChars(env, address, NULL);
...
JNIEXPORT void JNICALL
Java_com_example_scrawly_MobBridge_nativeDeliverBtHfpScoStopped(JNIEnv* env, jclass cls,
    jlong pid, jint session) {
    mob_deliver_bt_hfp_sco_stopped(pid, (int)session);
}

JNIEXPORT void JNICALL
Java_com_example_scrawly_MobBridge_nativeDeliverBtHfpScoAudio(JNIEnv* env, jclass cls,
...
JNIEXPORT void JNICALL
Java_com_example_scrawly_MobBridge_nativeDeliverBtHfpError(JNIEnv* env, jclass cls,
    jlong pid, jint session, jstring reason) {
    const char* c_reason = (*env)->GetStringUTFChars(env, reason, NULL);
...
JNIEXPORT void JNICALL
Java_com_example_scrawly_MobBridge_nativeDeliverBtSppConnected(JNIEnv* env, jclass cls,
    jlong pid, jint session, jstring address, jstring name) {
    const char* c_address = (*env)->GetStringUTFChars(env, address, NULL);
    const char* c_name    = (*env)->GetStringUTFChars(env, name,    NULL);
...
JNIEXPORT void JNICALL
Java_com_example_scrawly_MobBridge_nativeDeliverBtSppConnectFailed(JNIEnv* env, jclass cls,
    jlong pid, jstring address, jstring reason) {
    const char* c_address = (*env)->GetStringUTFChars(env, address, NULL);
    const char* c_reason  = (*env)->GetStringUTFChars(env, reason,  NULL);
...
JNIEXPORT void JNICALL
Java_com_example_scrawly_MobBridge_nativeDeliverBtSppDisconnected(JNIEnv* env, jclass cls,
    jlong pid, jint session, jstring reason) {
    const char* c_reason = (*env)->GetStringUTFChars(env, reason, NULL);
...
JNIEXPORT void JNICALL
Java_com_example_scrawly_MobBridge_nativeDeliverBtSppData(JNIEnv* env, jclass cls,
...
JNIEXPORT void JNICALL
Java_com_example_scrawly_MobBridge_nativeDeliverBtSppWritten(JNIEnv* env, jclass cls,
    jlong pid, jint session, jint size) {
    mob_deliver_bt_spp_written(pid, (int)session, (int)size);
}

JNIEXPORT void JNICALL
Java_com_example_scrawly_MobBridge_nativeDeliverBtSppError(JNIEnv* env, jclass cls,
    jlong pid, jint session, jstring reason) {
    const char* c_reason = (*env)->GetStringUTFChars(env, reason, NULL);
...
JNIEXPORT void JNICALL
Java_com_example_scrawly_MobBridge_nativeDeliverBtHidConnected(JNIEnv* env, jclass cls,
    jlong pid, jint session, jstring address) {
    const char* c_address = (*env)->GetStringUTFChars(env, address, NULL);
...
JNIEXPORT void JNICALL
Java_com_example_scrawly_MobBridge_nativeDeliverBtHidConnectFailed(JNIEnv* env, jclass cls,
    jlong pid, jstring address, jstring reason) {
    const char* c_address = (*env)->GetStringUTFChars(env, address, NULL);
    const char* c_reason  = (*env)->GetStringUTFChars(env, reason,  NULL);
...
JNIEXPORT void JNICALL
Java_com_example_scrawly_MobBridge_nativeDeliverBtHidDisconnected(JNIEnv* env, jclass cls,
    jlong pid, jint session, jstring reason) {
    const char* c_reason = (*env)->GetStringUTFChars(env, reason, NULL);
...
JNIEXPORT void JNICALL
Java_com_example_scrawly_MobBridge_nativeDeliverBtHidInput(JNIEnv* env, jclass cls,
...
JNIEXPORT void JNICALL
Java_com_example_scrawly_MobBridge_nativeDeliverBtHidRawReport(JNIEnv* env, jclass cls,
